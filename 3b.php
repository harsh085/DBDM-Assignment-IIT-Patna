<h3>3. The Cartesian product of the relations instructor and teaches.<br>&emsp; &ensp;&emsp; &ensp;a. LEFT JOIN</h3><br>
<center> <h1>Instructor LEFT JOIN Teaches</h1>
<?php 
	$query = "SELECT * FROM instructor LEFT JOIN teaches ON instructor.ID = teaches.ID;";
